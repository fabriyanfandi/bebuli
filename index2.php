<?php
	...
	{
   		 $pesan=$_POST["pesan"];
   		 mysqli_query ($koneksi,"insert into tb_input_suara set pesan='$pesan'");
	...
	else if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(isset($_FILES["recordedFile"]) && !$_FILES["recordedFile"]['error'])
		{
			...
			mysqli_query ($koneksi,"insert into tb_input_suara set file='$filesuara'");
		}
		else
		{
			$result["error"] = 1;
