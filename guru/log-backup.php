          ...
          <!-- Main content -->
            <div class="container-fluid">
              ...
              <!-- timeline time label -->
               <?php
               $id=$_GET['id'];
               $log = mysqli_query($koneksi,"select * from log where id_pesan='$id'");
               
	           while($l = mysqli_fetch_array($log)){
                $waktu = $l["tgl_log"];
                $tl = new DateTime($waktu);
                $tanggal = $tl->format('d-m-Y');
                $waktu = $tl->format('H:i');
               ?>
              <div class="time-label">
                <span class="bg-green"><?php echo $tanggal;?></span>
              </div>
              <!-- /.timeline-label -->
              <!-- timeline item -->
              <div>
                ...
                <div class="timeline-item">
                  <span class="time"><i class="fas fa-clock"></i> <?php echo $waktu;?></span>
                  <h3 class="timeline-header"><b><?php echo $l['judul_log']?></b></h3>
